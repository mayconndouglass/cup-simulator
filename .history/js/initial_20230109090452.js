...
const toggleMenu = (event) => {
  ...
  const nav = menuHamburguer.parentElement
  nav.classList.toggle('active')
}

// menuHamburguer.addEventListener('click', event => toggleMenu(event))
menuHamburguer.addEventListener('touchstart', event => toggleMenu(event))
